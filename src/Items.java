...
public class Items extends ArrayList{
    public Items(){
        ...
        // item 1
        Item item1 = new Item(1.01,4,2,2,3);
        Item item2 = new Item(1.02,2,4,2,3);
        Item item3 = new Item(1.03,2,2,4,3);

        // item 3
        Item item4 = new Item(3.01,3,3,3,5);

        // item 2
        Item item5 = new Item(2.02,2,4,3,4);
        Item item6 = new Item(2.03,3,2,4,4);
        Item item7 = new Item(2.04,3,4,2,4);
        Item item8 = new Item(2.05,4,2,3,4);
        Item item9 = new Item(2.06,4,3,2,4);
        Item item10 = new Item(2.01,2,3,4,4);



        /** initialize a new arrayList which holds all items.
         Items will be mainly used for accessing so an ArrayList
